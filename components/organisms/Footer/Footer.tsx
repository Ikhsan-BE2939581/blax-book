...
import { Calendar, Phone, Mail, MapPin, Facebook, Instagram, Twitter, Youtube } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-xl font-bold">FootballBook</h3>
            </div>
            <p className="text-gray-300 leading-relaxed">
              Platform booking futsal dan mini soccer terpercaya di Jakarta. 
              Bergabunglah dengan komunitas football terbesar dan nikmati pengalaman bermain yang tak terlupakan.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/lineup" className="text-gray-300 hover:text-sky-400 transition-colors duration-200">
                  Player Lineups
                </a>
              </li>
              <li>
                <a href="/news" className="text-gray-300 hover:text-sky-400 transition-colors duration-200">
                  Berita
                </a>
              </li>
              <li>
                <a href="/user-profile" className="text-gray-300 hover:text-sky-400 transition-colors duration-200">
                  Profile
                </a>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-gray-300">info@footballbook.com</p>
                  <p className="text-gray-300">support@footballbook.com</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 bg-gray-800 rounded-lg">
              <h5 className="font-semibold text-sky-400 mb-2">Jam Operasional</h5>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} FootballBook. All rights reserved.
            </div>
